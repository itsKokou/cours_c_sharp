...
namespace Gestion_Cours.back.services.impl
{
    public class ModuleService : IModuleService
    {
        ...
        private ModuleService(IModuleRepository moduleRepository)
        {
        ...
        public static IModuleService moduleService = null;
        public static IModuleService GetInstance(IModuleRepository moduleRepository)
        {
