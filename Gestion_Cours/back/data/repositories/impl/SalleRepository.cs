...
namespace Gestion_Cours.back.data.repositories.impl
{
    public class SalleRepository : DataBase, ISalleRepository
    {
        ...
        public static ISalleRepository salleRepository = null;
        public static ISalleRepository GetInstance()
        {
        ...
        {
            string SQL_SELECT = string.Format("select * from salles where isArchived like {0} and id={1}", 0,id);
            this.tableName = "ONESALLE";
            return ExecuteSelect(SQL_SELECT);
        }
