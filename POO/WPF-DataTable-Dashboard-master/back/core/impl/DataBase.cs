...
namespace Gestion_Cours_Projet.back.core.impl
{
    public class DataBase:IDataBase
    {
        private readonly string connectionString = ConfigurationManager.ConnectionStrings["GESTION_COURS"].ConnectionString;
